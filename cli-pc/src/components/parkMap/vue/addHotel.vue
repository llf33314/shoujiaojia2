    ...
    <div class="public-content">
      <el-form :model="addHotelReq" :rules="addHotelRules" ref="addHotelReq" label-width="130px" class="demo-ruleForm">
        <el-form-item label="酒店名称：" prop="name">
          <el-input v-model="addHotelReq.name" placeholder="长度不超过20个字符" style="width: 251px!important;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="文案介绍：" prop="introduce">
          <el-input v-model="addHotelReq.introduce" placeholder="长度不超过20个字符" style="width: 251px!important;"></el-input>
        </el-form-item>
        ...
        <el-form-item style="margin-top: 80px;">
          <el-button type="primary" @click="submitForm('addHotelReq')" :loading="loading.state" v-text="loading.text"></el-button>
