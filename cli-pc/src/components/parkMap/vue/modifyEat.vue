    ...
    <div class="public-content">
      <el-form :model="modifyEatReq" :rules="modifyEatRules" ref="modifyEatReq" label-width="130px" class="demo-ruleForm">
        <el-form-item label="店铺名称" prop="name">
          <el-input v-model="modifyEatReq.name" placeholder="长度不超过20个字符" style="width: 251px!important;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="文案介绍" prop="introduce">
          <el-input v-model="modifyEatReq.introduce" placeholder="长度不超过20个字符" style="width: 251px!important;"></el-input>
        </el-form-item>
