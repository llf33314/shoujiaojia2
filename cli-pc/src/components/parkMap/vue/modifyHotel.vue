    ...
    <div class="public-content">
      <el-form :model="modifyHotelReq" :rules="modifyHotelRules" ref="modifyHotelReq" label-width="130px" class="demo-ruleForm">
        ...
        <el-form-item label="店铺名称" prop="name">
          <el-input v-model="modifyHotelReq.name" placeholder="长度不超过20个字符" style="width: 251px!important;"></el-input>
        </el-form-item>
        ...
        <el-form-item label="文案介绍" prop="introduce">
          <el-input v-model="modifyHotelReq.introduce" placeholder="长度不超过20个字符" style="width: 251px!important;"></el-input>
        </el-form-item>
