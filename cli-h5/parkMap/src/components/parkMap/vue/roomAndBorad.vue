...
<template>
  <section>
    ...
    <div class="type-box-list" v-if="showListBox">
        ...
        <li class="type-list-item" v-for="(item,index) in listEats" @click="goToDetail(item.id,1)">
          ...
          <div class="right-content">
            ...
            <p class="icon-text over">
              <img class="icon" src="./../img/address-icon.png" alt="地址">
              <span v-text="item.address"></span>
            </p>
            <p class="icon-text over">
              <img class="icon" src="./../img/phone-icon.png" alt="电话">
              <span v-text="item.phone"></span>
            </p>
          </div>
        </li>
        <div class="no-more" v-if="eatsCurrent > eatsTotalPages">无更多...</div>
      </ul>
      <ul class="type-list" v-show="type==0" ref="hotelsBox">
        ...
        <div class="no-more" v-if="hotelsCurrent > hotelsTotalPages">无更多...</div>
      </ul>
    </div>
  </section>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 跳转详情
      goToDetail(id,type){
        this.$router.push({path: '/parkMap/detail/'+id+'/'+type})
      }
